...
public class DigestUtil {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        byte[] saltBytes = DigestUtil.decodeHex("12345678");
        byte[] curPwdBytes = DigestUtil.digestString("url=/api-cs/q".toString().getBytes("UTF-8"), saltBytes,
                DigestUtil.DEFAULT_DIGEST_TIMES, DigestUtil.SHA1);
        System.out.println(DigestUtil.encodeHex(curPwdBytes));
    }
